...
echo "🍎 Создание ${APP_NAME}.app (Desktop версия)..."
echo "========================================"
...
cp beast_app_desktop.py "${RESOURCES_DIR}/"
...
exec venv/bin/python3 beast_app_desktop.py
...
# 7. (Опционально) Создание иконки-плейсхолдера
echo "🎨 Настройка иконки..."
# Здесь можно добавить копирование реальной иконки
...
echo ""
echo "🎯 ВОЗМОЖНОСТИ:"
echo "   ✓ Desktop GUI интерфейс"
echo "   ✓ Drag & Drop папки"
