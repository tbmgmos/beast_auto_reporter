...
class FullReportGenerator:
    ...
    def _add_technical_table(self, doc: Document, tech_info: Dict) -> None:
        ...
        try:
            ...
            row_colors = ["00B050", "00B050", "00B050", "00B050", "00B050"]  # Зеленый
            ...
            # Зеленый
            self._set_cell_background(row.cells[8], "00B050")
            # Красный
            self._set_cell_background(row.cells[9], "FF0000")
            # Оранжевый
            self._set_cell_background(row.cells[10], "FFC000")
