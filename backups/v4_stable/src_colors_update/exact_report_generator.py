...
class ExactReportGenerator:
        ...
        try:
            ...
            for idx, (label, key, pdf_key) in enumerate(rows_data):
                ...
                if has_audio:
                    ...
                    text_color = "f36559" if has_incorrect_type else None
                    ...
                    if duration > 0:
                        ...
                        if not is_frame_aligned(duration, fps):
                            chrono_bg = "f36559"  # Красный - не кратен кадру
                        ...
                        # Затем проверяем совпадение с референсом
                            ...
                            if durations_match(duration, reference_duration):
                                chrono_bg = "266618"  # Зеленый - совпадает и кратен кадру
                            else:
                                chrono_bg = "f36559"  # Красный - не совпадает с референсом
                        else:
                            chrono_bg = "884c16"  # Коричневый - нет эталона, но кратен кадру
                    else:
                    ...
                    if key.startswith('audio') and pdf_key and pdf_key in tech_info:
                        ...
                        if lufs is not None:
                            ...
                            if abs(lufs - target_lufs) <= lufs_tolerance:
                                lufs_bg = "266618"  # Зеленый - норма
                            else:
                                lufs_bg = "f36559"  # Красный - превышение
                        ...
                        if true_peak is not None:
                            ...
                            if true_peak <= target_peak:
                                peak_bg = "266618"  # Зеленый - норма
                            else:
                                peak_bg = "f36559"  # Красный - превышение
                        ...
                        if lra is not None:
                            ...
                            if lra <= target_lra:
                                lra_bg = "266618"  # Зеленый - норма
                            else:
                                lra_bg = "f36559"  # Красный - превышение
                        ...
                        format_bg = "266618" if is_complete else "884c16"  # Зеленый или коричневый
                        ...
                        is_complete = co and (',' in co or 'Stereo' in co or '(' in co)
                        format_bg = "266618" if is_complete else "884c16"
                        self._format_cell(row.cells[6], bg=format_bg, align="left")
                        ...
                        row.cells[6].text = format_text
                        self._format_cell(row.cells[6], bg="266618", align="left")
            ...
            self._format_cell(row.cells[4], bg="266618")  # Зеленый - норма
            self._format_cell(row.cells[5], bg="f36559")  # Красный - превышение
            self._format_cell(row.cells[6], bg="884c16")  # Коричневый - нет данных
    ...
    def _add_me_technical_table(self, doc: Document, tech_info: Dict,
        ...
        try:
                ...
                if has_data:
                    ...
                    if key.startswith('audio') and pdf_key and pdf_key in tech_info:
                        ...
                        if true_peak is not None:
                            ...
                            peak_bg = "266618" if true_peak <= target_peak else "f36559"
                    ...
                    if key.startswith('audio'):
                        ...
                        format_text = f"{video_format} {fps_video}fps, TC: {timecode}"
                        row.cells[4].text = format_text
                        self._format_cell(row.cells[4], bg="266618", align="left")
            ...
            # Форматируем объединенную ячейку
            self._format_cell(cell_merged, bg="FFFFFF", align="center")
            self._format_cell(row.cells[2], bg="266618")
            self._format_cell(row.cells[3], bg="f36559")
            self._format_cell(row.cells[4], bg="884c16")
        ...
        try:
            ...
            for row_idx, issue in enumerate(issues):
                ...
                for col_idx, cell in enumerate(row.cells):
                    ...
                    text_color = "f36559" if col_idx == 2 and has_incorrect_type else None
