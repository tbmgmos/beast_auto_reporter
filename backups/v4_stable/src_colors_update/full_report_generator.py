...
class FullReportGenerator:
    ...
    def _add_technical_table(self, doc: Document, tech_info: Dict) -> None:
        ...
        try:
            ...
            row_colors = ["266618", "266618", "266618", "266618", "266618"]  # Зеленый
            ...
            # Зеленый
            self._set_cell_background(row.cells[8], "266618")
            # Красный
            self._set_cell_background(row.cells[9], "f36559")
            # Коричневый
            self._set_cell_background(row.cells[10], "884c16")
