#!/bin/bash
# ============================================================================
# Create DMG from Beast Auto Reporter.app
# ============================================================================
set -euo pipefail
...
DMG_NAME="Beast_Auto_Reporter_${APP_VERSION}_arm64.dmg"
DMG_PATH="dist/$DMG_NAME"
VOLUME_NAME="Beast Auto Reporter"

if [ ! -d "$APP_PATH" ]; then
    echo "❌ $APP_PATH не найден. Сначала запустите: ./scripts/build_app.sh"
    exit 1
fi
...
echo ""
echo "   Отправьте этот файл на другой Mac для установки."
